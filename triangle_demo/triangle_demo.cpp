...
private:
    ...
    bool isDeviceSuitable(VkPhysicalDevice device)
    {
        ...
        std::cout << "deviceProperties.deviceType : " << deviceProperties.deviceType << std::endl;
...
int main(int argc, char *argv[])
{
    if (argc > 1)
    {
        if (strcmp(argv[1], "--enableValidationLayers") == 0)
        {
            std::cout << "Enable the ValidationLayers" << std::endl;
